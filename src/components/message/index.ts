...
const successStyle: IMessageCss = {
  bodyClass: 'text-green-700 bg-green-100 dark:bg-green-200 dark:text-green-800',
...
const warnStyle: IMessageCss = {
  bodyClass: 'text-yellow-700 bg-yellow-100 dark:bg-yellow-200 dark:text-yellow-800',
