...
import dataJson from '@/../data/v.8.0.0.json';
...
export const availableInkCount = [...new Set(getCardList().c.map((c) => inkCount(c.g, c.sg)))].sort((a, b) => a - b);
export const availableSP = [...new Set(getCardList().c.map((c) => c.sp))].sort((a, b) => a - b);
